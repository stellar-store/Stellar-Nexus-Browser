...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BookmarkManager_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BookmarkManager_t qt_meta_stringdata_BookmarkManager = {
    {
        QT_MOC_LITERAL(0, 15),  // "BookmarkManager"
        QT_MOC_LITERAL(16, 16),  // "bookmarksChanged"
        QT_MOC_LITERAL(33, 0)   // ""
    },
    "BookmarkManager",
    "bookmarksChanged",
...
Q_CONSTINIT static const uint qt_meta_data_BookmarkManager[] = {
...
Q_CONSTINIT const QMetaObject BookmarkManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_BookmarkManager.offsetsAndSizes,
    qt_meta_data_BookmarkManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BookmarkManager_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BookmarkManager, std::true_type>,
        // method 'bookmarksChanged'
...
void BookmarkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &BookmarkManager::bookmarksChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BookmarkManager::bookmarksChanged()
{
