...
Q_CONSTINIT static const qt_meta_stringdata_DownloadManager_t qt_meta_stringdata_DownloadManager = {
    {
        ...
        QT_MOC_LITERAL(16, 15),  // "downloadStarted"
        QT_MOC_LITERAL(32, 0),  // ""
...
void DownloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->downloadFinished((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DownloadManager::downloadStarted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
